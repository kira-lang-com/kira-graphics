...
@kira_str_0_data = private unnamed_addr constant [19 x i8] c"Kira Rotating Cube\00"

@kira_str_0 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([19 x i8], ptr @kira_str_0_data, i64 0, i64 0), i64 18 }

@kira_str_1_data = private unnamed_addr constant [1378 x i8] c"#version 330\0Aout vec4 color;\0Aconst vec3 positions[36] = vec3[36](\0A    vec3(-0.45, -0.45, -0.45), vec3(0.45, -0.45, -0.45), vec3(0.45, 0.45, -0.45),\0A    vec3(-0.45, -0.45, -0.45), vec3(0.45, 0.45, -0.45), vec3(-0.45, 0.45, -0.45),\0A    vec3(-0.45, -0.45, 0.45), vec3(0.45, -0.45, 0.45), vec3(0.45, 0.45, 0.45),\0A    vec3(-0.45, -0.45, 0.45), vec3(0.45, 0.45, 0.45), vec3(-0.45, 0.45, 0.45),\0A    vec3(-0.45, -0.45, -0.45), vec3(-0.45, 0.45, -0.45), vec3(-0.45, 0.45, 0.45),\0A    vec3(-0.45, -0.45, -0.45), vec3(-0.45, 0.45, 0.45), vec3(-0.45, -0.45, 0.45),\0A    vec3(0.45, -0.45, -0.45), vec3(0.45, 0.45, -0.45), vec3(0.45, 0.45, 0.45),\0A    vec3(0.45, -0.45, -0.45), vec3(0.45, 0.45, 0.45), vec3(0.45, -0.45, 0.45),\0A    vec3(-0.45, -0.45, -0.45), vec3(0.45, -0.45, -0.45), vec3(0.45, -0.45, 0.45),\0A    vec3(-0.45, -0.45, -0.45), vec3(0.45, -0.45, 0.45), vec3(-0.45, -0.45, 0.45),\0A    vec3(-0.45, 0.45, -0.45), vec3(0.45, 0.45, -0.45), vec3(0.45, 0.45, 0.45),\0A    vec3(-0.45, 0.45, -0.45), vec3(0.45, 0.45, 0.45), vec3(-0.45, 0.45, 0.45)\0A);\0Aconst vec4 colors[6] = vec4[6](\0A    vec4(1.0, 0.3, 0.3, 1.0),\0A    vec4(0.3, 1.0, 0.4, 1.0),\0A    vec4(0.3, 0.5, 1.0, 1.0),\0A    vec4(1.0, 0.8, 0.3, 1.0),\0A    vec4(0.9, 0.3, 1.0, 1.0),\0A    vec4(0.3, 1.0, 1.0, 1.0)\0A);\0Avoid main() {\0A    vec3 p = positions[gl_VertexID];\0A    gl_Position = vec4(p.xy, 0.0, 1.0);\0A    color = colors[gl_VertexID / 6];\0A}\00"

@kira_str_1 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([1378 x i8], ptr @kira_str_1_data, i64 0, i64 0), i64 1377 }
...
@kira_str_3_data = private unnamed_addr constant [5 x i8] c"cube\00"

@kira_str_3 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([5 x i8], ptr @kira_str_3_data, i64 0, i64 0), i64 4 }

@kira_str_4_data = private unnamed_addr constant [14 x i8] c"cube-pipeline\00"

@kira_str_4 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([14 x i8], ptr @kira_str_4_data, i64 0, i64 0), i64 13 }
...
entry:
  ...
  %field.ptr.21 = getelementptr inbounds %t.sg_shader_desc, ptr %field.base.21, i32 0, i32 10
  %r21 = ptrtoint ptr %field.ptr.21 to i64
  %store.ptr.19 = inttoptr i64 %r21 to ptr
  %store.cstr.19 = extractvalue %kira.string %r19, 0
  store ptr %store.cstr.19, ptr %store.ptr.19
  %r22 = ptrtoint ptr %local3 to i64
  %call.arg.126.0 = inttoptr i64 %r22 to ptr
  %call.struct.23 = call %t.sg_shader @"sg_make_shader"(ptr %call.arg.126.0)
  %call.ret.ptr.23 = alloca %t.sg_shader
  store %t.sg_shader %call.struct.23, ptr %call.ret.ptr.23
  %r23 = ptrtoint ptr %call.ret.ptr.23 to i64
  %r24 = load i64, ptr %local1
  %field.base.25 = inttoptr i64 %r24 to ptr
  %field.ptr.25 = getelementptr inbounds %t.app_state, ptr %field.base.25, i32 0, i32 0
  %r25 = ptrtoint ptr %field.ptr.25 to i64
  %copy.dst.25 = inttoptr i64 %r25 to ptr
  %copy.src.23 = inttoptr i64 %r23 to ptr
  %copy.val.25 = load %t.sg_shader, ptr %copy.src.23
  store %t.sg_shader %copy.val.25, ptr %copy.dst.25
  %r26 = load i64, ptr %local1
  %field.base.27 = inttoptr i64 %r26 to ptr
  %field.ptr.27 = getelementptr inbounds %t.app_state, ptr %field.base.27, i32 0, i32 0
  %r27 = ptrtoint ptr %field.ptr.27 to i64
  %r28 = ptrtoint ptr %local4 to i64
  %field.base.29 = inttoptr i64 %r28 to ptr
  %field.ptr.29 = getelementptr inbounds %t.sg_pipeline_desc, ptr %field.base.29, i32 0, i32 2
  %r29 = ptrtoint ptr %field.ptr.29 to i64
  %copy.dst.29 = inttoptr i64 %r29 to ptr
  %copy.src.27 = inttoptr i64 %r27 to ptr
  %copy.val.29 = load %t.sg_shader, ptr %copy.src.27
  store %t.sg_shader %copy.val.29, ptr %copy.dst.29
  %r30 = load %kira.string, ptr @kira_str_4
  %r31 = ptrtoint ptr %local4 to i64
  %field.base.32 = inttoptr i64 %r31 to ptr
  %field.ptr.32 = getelementptr inbounds %t.sg_pipeline_desc, ptr %field.base.32, i32 0, i32 15
  %r32 = ptrtoint ptr %field.ptr.32 to i64
  %store.ptr.30 = inttoptr i64 %r32 to ptr
  %store.cstr.30 = extractvalue %kira.string %r30, 0
  store ptr %store.cstr.30, ptr %store.ptr.30
  %r33 = ptrtoint ptr %local4 to i64
  %call.arg.124.0 = inttoptr i64 %r33 to ptr
  %call.struct.34 = call %t.sg_pipeline @"sg_make_pipeline"(ptr %call.arg.124.0)
  %call.ret.ptr.34 = alloca %t.sg_pipeline
  store %t.sg_pipeline %call.struct.34, ptr %call.ret.ptr.34
  %r34 = ptrtoint ptr %call.ret.ptr.34 to i64
  %r35 = load i64, ptr %local1
  %field.base.36 = inttoptr i64 %r35 to ptr
  %field.ptr.36 = getelementptr inbounds %t.app_state, ptr %field.base.36, i32 0, i32 1
  %r36 = ptrtoint ptr %field.ptr.36 to i64
  %copy.dst.36 = inttoptr i64 %r36 to ptr
  %copy.src.34 = inttoptr i64 %r34 to ptr
  %copy.val.36 = load %t.sg_pipeline, ptr %copy.src.34
  store %t.sg_pipeline %copy.val.36, ptr %copy.dst.36
  ret void
}
