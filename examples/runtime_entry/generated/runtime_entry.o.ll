...
%t.RuntimeState = type { i64, i64, i64 }
...
define void @"kira_release_contents_RuntimeState"(ptr %value) {
entry:
  ret void
}
define void @"kira_destroy_RuntimeState"(ptr %value) {
entry:
  %isnull = icmp eq ptr %value, null
  br i1 %isnull, label %done, label %body
body:
  call void @"kira_release_contents_RuntimeState"(ptr %value)
  call void @free(ptr %value)
  br label %done
done:
  ret void
...
@kira_str_0_data = private unnamed_addr constant [28 x i8] c"Kira Graphics Runtime Entry\00"

@kira_str_0 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([28 x i8], ptr @kira_str_0_data, i64 0, i64 0), i64 27 }
...
entry:
  ...
  %alloc.size.ptr.16 = getelementptr %t.RuntimeState, ptr null, i32 1
  ...
  %native.state.box.23 = call ptr @"kira_native_state_alloc"(i64 5889691409904188428, i64 %native.state.size.23)
  ...
  %native.state.src.field.ptr.23.0 = getelementptr inbounds %t.RuntimeState, ptr %native.state.src.23, i32 0, i32 0
  %native.state.slot.ptr.23.0 = getelementptr inbounds %kira.bridge.value, ptr %native.state.payload.23, i64 0
  %native.state.pack.23.0.0 = insertvalue %kira.bridge.value zeroinitializer, i8 1, 0
  %native.state.load.int.23.0 = load i64, ptr %native.state.src.field.ptr.23.0
  %native.state.pack.23.0 = insertvalue %kira.bridge.value %native.state.pack.23.0.0, i64 %native.state.load.int.23.0, 2
  store %kira.bridge.value %native.state.pack.23.0, ptr %native.state.slot.ptr.23.0
  %native.state.src.field.ptr.23.1 = getelementptr inbounds %t.RuntimeState, ptr %native.state.src.23, i32 0, i32 1
  %native.state.slot.ptr.23.1 = getelementptr inbounds %kira.bridge.value, ptr %native.state.payload.23, i64 1
  %native.state.pack.23.1.0 = insertvalue %kira.bridge.value zeroinitializer, i8 1, 0
  %native.state.load.int.23.1 = load i64, ptr %native.state.src.field.ptr.23.1
  %native.state.pack.23.1 = insertvalue %kira.bridge.value %native.state.pack.23.1.0, i64 %native.state.load.int.23.1, 2
  store %kira.bridge.value %native.state.pack.23.1, ptr %native.state.slot.ptr.23.1
  %native.state.src.field.ptr.23.2 = getelementptr inbounds %t.RuntimeState, ptr %native.state.src.23, i32 0, i32 2
  %native.state.slot.ptr.23.2 = getelementptr inbounds %kira.bridge.value, ptr %native.state.payload.23, i64 2
  %native.state.pack.23.2.0 = insertvalue %kira.bridge.value zeroinitializer, i8 1, 0
  %native.state.load.int.23.2 = load i64, ptr %native.state.src.field.ptr.23.2
  %native.state.pack.23.2 = insertvalue %kira.bridge.value %native.state.pack.23.2.0, i64 %native.state.load.int.23.2, 2
  ...
  %r25 = add i64 0, 442
  call void @"kira_fn_399_GraphicsApplication.onInit"(i64 %r24, i64 %r25)
  %r26 = load i64, ptr %local0
  %r27 = add i64 0, 443
  call void @"kira_fn_400_GraphicsApplication.onFrame"(i64 %r26, i64 %r27)
  %r28 = load i64, ptr %local0
  %r29 = add i64 0, 445
  call void @"kira_fn_401_GraphicsApplication.onCleanup"(i64 %r28, i64 %r29)
  %r30 = load i64, ptr %local0
  %r31 = load i64, ptr %local1
  call void @"kira_fn_402_GraphicsApplication.run"(i64 %r30, i64 %r31)
...
define void @"kira_fn_399_GraphicsApplication.onInit"(i64 %arg0, i64 %arg1) {
entry:
  %local0 = alloca i64
  %local.storage.0 = alloca %t.GraphicsApplication
  store %t.GraphicsApplication zeroinitializer, ptr %local.storage.0
...
define void @"kira_fn_401_GraphicsApplication.onCleanup"(i64 %arg0, i64 %arg1) {
entry:
  %local0 = alloca i64
  %local.storage.0 = alloca %t.GraphicsApplication
  store %t.GraphicsApplication zeroinitializer, ptr %local.storage.0
...
entry:
  ...
  %r2 = ptrtoint ptr %load.rawptr.2 to i64
  %native.recover.state.3 = inttoptr i64 %r2 to ptr
  %native.recover.payload.3 = call ptr @"kira_native_state_recover"(ptr %native.recover.state.3, i64 5889691409904188428)
  %r3 = ptrtoint ptr %native.recover.payload.3 to i64
  ...
  %r5 = extractvalue %kira.bridge.value %native.state.get.val.0, 2
  %r6 = add i64 0, 1
  %r7 = add i64 %r5, %r6
  %r8 = load i64, ptr %local1
  %native.state.set.ptr.7 = inttoptr i64 %r8 to ptr
  %native.state.set.slot.7 = getelementptr inbounds %kira.bridge.value, ptr %native.state.set.ptr.7, i64 0
  %native.state.set.pack.1.0 = insertvalue %kira.bridge.value zeroinitializer, i8 1, 0
  %native.state.set.pack.1 = insertvalue %kira.bridge.value %native.state.set.pack.1.0, i64 %r7, 2
  store %kira.bridge.value %native.state.set.pack.1, ptr %native.state.set.slot.7
  ret void
}

define void @"kira_fn_444_main$callback_443$callback_444"(i64 %arg0) {
entry:
  %local0 = alloca i64
  %local.storage.0 = alloca %t.RenderEncoder
  store %t.RenderEncoder zeroinitializer, ptr %local.storage.0
...
define void @"kira_fn_443_main$callback_443"(i64 %arg0) {
entry:
  %local0 = alloca i64
  %local.storage.0 = alloca %t.GraphicsFrame
  store %t.GraphicsFrame zeroinitializer, ptr %local.storage.0
  ...
  %r8 = load i64, ptr %local1
  %native.state.set.ptr.7 = inttoptr i64 %r8 to ptr
  %native.state.set.slot.7 = getelementptr inbounds %kira.bridge.value, ptr %native.state.set.ptr.7, i64 1
  %native.state.set.pack.1.0 = insertvalue %kira.bridge.value zeroinitializer, i8 1, 0
  %native.state.set.pack.1 = insertvalue %kira.bridge.value %native.state.set.pack.1.0, i64 %r7, 2
  store %kira.bridge.value %native.state.set.pack.1, ptr %native.state.set.slot.7
  %r9 = load i64, ptr %local0
  %alloc.size.ptr.10 = getelementptr %t.Color, ptr null, i32 1
  %alloc.size.10 = ptrtoint ptr %alloc.size.ptr.10 to i64
  %alloc.empty.10 = icmp eq i64 %alloc.size.10, 0
  %alloc.bytes.10 = select i1 %alloc.empty.10, i64 1, i64 %alloc.size.10
  %alloc.ptr.10 = call ptr @malloc(i64 %alloc.bytes.10)
  store %t.Color zeroinitializer, ptr %alloc.ptr.10
  %r10 = ptrtoint ptr %alloc.ptr.10 to i64
  store ptr %alloc.ptr.10, ptr %cleanup.heap.slot.10
  %r11 = fadd double 0.0, 0.1
  %field.base.12 = inttoptr i64 %r10 to ptr
  %field.ptr.12 = getelementptr inbounds %t.Color, ptr %field.base.12, i32 0, i32 0
  %r12 = ptrtoint ptr %field.ptr.12 to i64
  %store.ptr.11 = inttoptr i64 %r12 to ptr
  store double %r11, ptr %store.ptr.11
  %r13 = fadd double 0.0, 0.1
  %field.base.14 = inttoptr i64 %r10 to ptr
  %field.ptr.14 = getelementptr inbounds %t.Color, ptr %field.base.14, i32 0, i32 1
  %r14 = ptrtoint ptr %field.ptr.14 to i64
  %store.ptr.13 = inttoptr i64 %r14 to ptr
  store double %r13, ptr %store.ptr.13
  %r15 = fadd double 0.0, 0.13
  %field.base.16 = inttoptr i64 %r10 to ptr
  %field.ptr.16 = getelementptr inbounds %t.Color, ptr %field.base.16, i32 0, i32 2
  %r16 = ptrtoint ptr %field.ptr.16 to i64
  %store.ptr.15 = inttoptr i64 %r16 to ptr
  store double %r15, ptr %store.ptr.15
  %r17 = fadd double 0.0, 1.0
  ...
  store double %r17, ptr %store.ptr.17
  %r19 = add i64 0, 444
  call void @"kira_fn_407_GraphicsFrame.pass"(i64 %r9, i64 %r10, i64 %r19)
  %r20 = load i64, ptr %local0
  call void @"kira_fn_408_GraphicsFrame.requestQuit"(i64 %r20)
  %cleanup.heap.ptr.2 = load ptr, ptr %cleanup.heap.slot.10
  call void @free(ptr %cleanup.heap.ptr.2)
  ret void
}
...
entry:
  ...
  %r4 = load i64, ptr %local1
  %native.state.get.ptr.5 = inttoptr i64 %r4 to ptr
  %native.state.get.slot.5 = getelementptr inbounds %kira.bridge.value, ptr %native.state.get.ptr.5, i64 2
  %native.state.get.val.0 = load %kira.bridge.value, ptr %native.state.get.slot.5
  %r5 = extractvalue %kira.bridge.value %native.state.get.val.0, 2
  %r6 = add i64 0, 1
  %r7 = add i64 %r5, %r6
  %r8 = load i64, ptr %local1
  %native.state.set.ptr.7 = inttoptr i64 %r8 to ptr
  %native.state.set.slot.7 = getelementptr inbounds %kira.bridge.value, ptr %native.state.set.ptr.7, i64 2
  %native.state.set.pack.1.0 = insertvalue %kira.bridge.value zeroinitializer, i8 1, 0
  %native.state.set.pack.1 = insertvalue %kira.bridge.value %native.state.set.pack.1.0, i64 %r7, 2
  store %kira.bridge.value %native.state.set.pack.1, ptr %native.state.set.slot.7
  %r9 = load i64, ptr %local1
  %native.state.get.ptr.10 = inttoptr i64 %r9 to ptr
  %native.state.get.slot.10 = getelementptr inbounds %kira.bridge.value, ptr %native.state.get.ptr.10, i64 0
  ...
  call void @"kira_native_write_i64"(i64 %r10)
  call void @"kira_native_write_newline"()
  %r11 = load i64, ptr %local1
  ...
  %native.state.get.val.3 = load %kira.bridge.value, ptr %native.state.get.slot.12
  %r12 = extractvalue %kira.bridge.value %native.state.get.val.3, 2
  call void @"kira_native_write_i64"(i64 %r12)
  call void @"kira_native_write_newline"()
  %r13 = load i64, ptr %local1
  %native.state.get.ptr.14 = inttoptr i64 %r13 to ptr
  ...
  call void @"kira_native_write_i64"(i64 %r14)
  call void @"kira_native_write_newline"()
  ret void
}
...
dispatch.direct:
  switch i64 %function_id, label %dispatch.default [
    ...
    i64 442, label %dispatch.case.2
    i64 445, label %dispatch.case.3
  ]
dispatch.case.0:
...
dispatch.case.4:
  ...
  ret void
dispatch.case.5:
  call void @"kira_fn_443_main$callback_443"(i64 %arg0)
  ret void
dispatch.closure:
  %closure.raw = and i64 %function_id, 9223372036854775807
  %closure.ptr = inttoptr i64 %closure.raw to ptr
...
dispatch.direct:
  switch i64 %function_id, label %dispatch.default [
    ...
    i64 444, label %dispatch.case.1
  ]
dispatch.case.0:
  call void @"kira_fn_437_RenderEncoder.popClip"(i64 %arg0)
  ret void
dispatch.case.1:
  call void @"kira_fn_444_main$callback_443$callback_444"(i64 %arg0)
  ret void
dispatch.closure:
  %closure.raw = and i64 %function_id, 9223372036854775807
  %closure.ptr = inttoptr i64 %closure.raw to ptr
