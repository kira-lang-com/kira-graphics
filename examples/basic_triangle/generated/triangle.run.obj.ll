...
@kira_str_4_data = private unnamed_addr constant [30 x i8] c"Running scene: \5C(scene.label)\00"

@kira_str_4 = private unnamed_addr constant %kira.string { ptr getelementptr inbounds ([30 x i8], ptr @kira_str_4_data, i64 0, i64 0), i64 29 }


define void @"kira_fn_0_main"() {
entry:
  %local0 = alloca i64
  %local.size.ptr.0 = getelementptr inbounds %t.Application, ptr null, i32 1
  %local.size.0 = ptrtoint ptr %local.size.ptr.0 to i64
  %local.heap.0 = call ptr @malloc(i64 %local.size.0)
  store %t.Application zeroinitializer, ptr %local.heap.0
  %local.heap.int.0 = ptrtoint ptr %local.heap.0 to i64
  store i64 %local.heap.int.0, ptr %local0
  %local1 = alloca i64
  %local.size.ptr.1 = getelementptr inbounds %t.Scene, ptr null, i32 1
  %local.size.1 = ptrtoint ptr %local.size.ptr.1 to i64
  %local.heap.1 = call ptr @malloc(i64 %local.size.1)
  store %t.Scene zeroinitializer, ptr %local.heap.1
  %local.heap.int.1 = ptrtoint ptr %local.heap.1 to i64
  store i64 %local.heap.int.1, ptr %local1
  %alloc.size.ptr.0 = getelementptr inbounds %t.Application, ptr null, i32 1
  %alloc.size.0 = ptrtoint ptr %alloc.size.ptr.0 to i64
  %alloc.ptr.0 = call ptr @malloc(i64 %alloc.size.0)
  store %t.Application zeroinitializer, ptr %alloc.ptr.0
  ...
  %alloc.size.ptr.11 = getelementptr inbounds %t.Scene, ptr null, i32 1
  %alloc.size.11 = ptrtoint ptr %alloc.size.ptr.11 to i64
  %alloc.ptr.11 = call ptr @malloc(i64 %alloc.size.11)
  store %t.Scene zeroinitializer, ptr %alloc.ptr.11
  ...
  call void @"kira_fn_1_Application.run"(i64 %r25, i64 %r26)
  ret void
}

define void @"kira_fn_1_Application.run"(i64 %arg0, i64 %arg1) {
entry:
  %local0 = alloca i64
  %local.size.ptr.0 = getelementptr inbounds %t.Application, ptr null, i32 1
  %local.size.0 = ptrtoint ptr %local.size.ptr.0 to i64
  ...
  %r3 = load %kira.string, ptr %load.ptr.3
  ...
  %field.ptr.11 = getelementptr inbounds %t.Scene, ptr %field.base.11, i32 0, i32 0
  %r11 = ptrtoint ptr %field.ptr.11 to i64
  %load.ptr.12 = inttoptr i64 %r11 to ptr
  %r12 = load %kira.string, ptr %load.ptr.12
  %r13 = load i64, ptr %local1
  %field.base.14 = inttoptr i64 %r13 to ptr
  %field.ptr.14 = getelementptr inbounds %t.Scene, ptr %field.base.14, i32 0, i32 1
  %r14 = ptrtoint ptr %field.ptr.14 to i64
  %load.ptr.15 = inttoptr i64 %r14 to ptr
  %r15 = load %kira.string, ptr %load.ptr.15
  %r16 = load i64, ptr %local1
  %field.base.17 = inttoptr i64 %r16 to ptr
  %field.ptr.17 = getelementptr inbounds %t.Scene, ptr %field.base.17, i32 0, i32 2
  %r17 = ptrtoint ptr %field.ptr.17 to i64
  %load.ptr.18 = inttoptr i64 %r17 to ptr
  %r18 = load %kira.string, ptr %load.ptr.18
  %r19 = load i64, ptr %local1
  %field.base.20 = inttoptr i64 %r19 to ptr
  %field.ptr.20 = getelementptr inbounds %t.Scene, ptr %field.base.20, i32 0, i32 3
  %r20 = ptrtoint ptr %field.ptr.20 to i64
  %load.ptr.21 = inttoptr i64 %r20 to ptr
  %load.raw.21 = load i32, ptr %load.ptr.21
  %r21 = sext i32 %load.raw.21 to i64
  call void @"kira_fn_5_RunBackendApp"(%kira.string %r3, i64 %r6, i64 %r9, %kira.string %r12, %kira.string %r15, %kira.string %r18, i64 %r21)
  ret void
}

define void @"kira_fn_2_backend_on_init"(i64 %arg0) {
entry:
  %local0 = alloca i64
  %local1 = alloca i64
  %local2 = alloca i64
  ...
  %call.arg.189.0 = inttoptr i64 %r10 to ptr
  call void @"sg_setup"(ptr %call.arg.189.0)
  ...
  %call.arg.127.0 = inttoptr i64 %r28 to ptr
  %call.struct.29 = call %t.sg_shader @"sg_make_shader"(ptr %call.arg.127.0)
  ...
  %r41 = load i64, ptr %local4
  %call.arg.125.0 = inttoptr i64 %r41 to ptr
  %call.struct.42 = call %t.sg_pipeline @"sg_make_pipeline"(ptr %call.arg.125.0)
...
define void @"kira_fn_3_backend_on_frame"(i64 %arg0) {
entry:
  %local0 = alloca i64
  %local1 = alloca i64
  %local2 = alloca i64
  ...
  %r10 = load i64, ptr %local2
  %call.arg.76.0 = inttoptr i64 %r10 to ptr
  call void @"sg_begin_pass"(ptr %call.arg.76.0)
  %r11 = add i64 0, 0
  %r12 = add i64 0, 0
  %r13 = load i64, ptr %local1
  %field.base.14 = inttoptr i64 %r13 to ptr
  ...
  %r19 = add i1 0, 1
  %call.arg.74.0 = trunc i64 %r11 to i32
  %call.arg.74.1 = trunc i64 %r12 to i32
  %call.arg.74.2 = trunc i64 %r15 to i32
  %call.arg.74.3 = trunc i64 %r18 to i32
  call void @"sg_apply_viewport"(i32 %call.arg.74.0, i32 %call.arg.74.1, i32 %call.arg.74.2, i32 %call.arg.74.3, i1 %r19)
  %r20 = load i64, ptr %local1
  %field.base.21 = inttoptr i64 %r20 to ptr
  %field.ptr.21 = getelementptr inbounds %t.backend_state, ptr %field.base.21, i32 0, i32 1
  %r21 = ptrtoint ptr %field.ptr.21 to i64
  %call.arg.ptr.70.0 = inttoptr i64 %r21 to ptr
  %call.arg.70.0 = load %t.sg_pipeline, ptr %call.arg.ptr.70.0
  call void @"sg_apply_pipeline"(%t.sg_pipeline %call.arg.70.0)
  %r22 = add i64 0, 0
  %r23 = load i64, ptr %local1
  %field.base.24 = inttoptr i64 %r23 to ptr
  ...
  %r26 = add i64 0, 1
  %call.arg.100.0 = trunc i64 %r22 to i32
  %call.arg.100.1 = trunc i64 %r25 to i32
  %call.arg.100.2 = trunc i64 %r26 to i32
  call void @"sg_draw"(i32 %call.arg.100.0, i32 %call.arg.100.1, i32 %call.arg.100.2)
  call void @"sg_end_pass"()
  call void @"sg_commit"()
  ret void
}

define void @"kira_fn_4_backend_on_cleanup"(i64 %arg0) {
entry:
  %local0 = alloca i64
  %local1 = alloca i64
  store i64 %arg0, ptr %local0
  ...
  %r2 = ptrtoint ptr %field.ptr.2 to i64
  %call.arg.ptr.94.0 = inttoptr i64 %r2 to ptr
  %call.arg.94.0 = load %t.sg_pipeline, ptr %call.arg.ptr.94.0
  call void @"sg_destroy_pipeline"(%t.sg_pipeline %call.arg.94.0)
  %r3 = load i64, ptr %local1
  %field.base.4 = inttoptr i64 %r3 to ptr
  %field.ptr.4 = getelementptr inbounds %t.backend_state, ptr %field.base.4, i32 0, i32 0
  %r4 = ptrtoint ptr %field.ptr.4 to i64
  %call.arg.ptr.96.0 = inttoptr i64 %r4 to ptr
  %call.arg.96.0 = load %t.sg_shader, ptr %call.arg.ptr.96.0
  call void @"sg_destroy_shader"(%t.sg_shader %call.arg.96.0)
  call void @"sg_shutdown"()
  ret void
}

define void @"kira_fn_5_RunBackendApp"(%kira.string %arg0, i64 %arg1, i64 %arg2, %kira.string %arg3, %kira.string %arg4, %kira.string %arg5, i64 %arg6) {
entry:
  ...
  %local6 = alloca i64
  %local7 = alloca i64
  %local.size.ptr.7 = getelementptr inbounds %t.backend_state, ptr null, i32 1
  %local.size.7 = ptrtoint ptr %local.size.ptr.7 to i64
  %local.heap.7 = call ptr @malloc(i64 %local.size.7)
  store %t.backend_state zeroinitializer, ptr %local.heap.7
  %local.heap.int.7 = ptrtoint ptr %local.heap.7 to i64
  store i64 %local.heap.int.7, ptr %local7
  %local8 = alloca i64
  %local.size.ptr.8 = getelementptr inbounds %t.sapp_desc, ptr null, i32 1
  %local.size.8 = ptrtoint ptr %local.size.ptr.8 to i64
  %local.heap.8 = call ptr @malloc(i64 %local.size.8)
  store %t.sapp_desc zeroinitializer, ptr %local.heap.8
  %local.heap.int.8 = ptrtoint ptr %local.heap.8 to i64
  store i64 %local.heap.int.8, ptr %local8
  ...
  %r18 = ptrtoint ptr @"kira_fn_2_backend_on_init" to i64
  %r19 = load i64, ptr %local8
  %field.base.20 = inttoptr i64 %r19 to ptr
  ...
  %r21 = ptrtoint ptr @"kira_fn_3_backend_on_frame" to i64
  %r22 = load i64, ptr %local8
  ...
  %r24 = ptrtoint ptr @"kira_fn_4_backend_on_cleanup" to i64
  %r25 = load i64, ptr %local8
  ...
  %r27 = load i64, ptr %local7
  %r28 = load i64, ptr %local8
  ...
  %r39 = load i64, ptr %local8
  %call.arg.45.0 = inttoptr i64 %r39 to ptr
  call void @"sapp_run"(ptr %call.arg.45.0)
  ret void
}
