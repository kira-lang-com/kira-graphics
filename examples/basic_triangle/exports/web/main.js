...
// include: /var/folders/v6/6q3jy9nd3pscgwcf3d5ygdxc0000gn/T/tmp5eehuc79.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/Users/priamc/Code/kira-projects/kira-graphics/examples/basic_triangle/exports/web-build/main.data';
...
Module['FS_createPath']("/", "generated", true, true);
Module['FS_createPath']("/generated", "Shaders", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_/Users/priamc/Code/kira-projects/kira-graphics/examples/basic_triangle/exports/web-build/main.data');
      }
      Module['addRunDependency']('datafile_/Users/priamc/Code/kira-projects/kira-graphics/examples/basic_triangle/exports/web-build/main.data');
    ...
    loadPackage({"files": [{"filename": "/generated/Shaders/BasicTriangle.frag.glsl", "start": 0, "end": 596}, {"filename": "/generated/Shaders/BasicTriangle.frag.wgsl", "start": 596, "end": 1170}, {"filename": "/generated/Shaders/BasicTriangle.reflection.json", "start": 1170, "end": 2647}, {"filename": "/generated/Shaders/BasicTriangle.vert.glsl", "start": 2647, "end": 3400}, {"filename": "/generated/Shaders/BasicTriangle.vert.wgsl", "start": 3400, "end": 4083}], "remote_package_size": 4083});

  })();

// end include: /var/folders/v6/6q3jy9nd3pscgwcf3d5ygdxc0000gn/T/tmp5eehuc79.js
// include: /var/folders/v6/6q3jy9nd3pscgwcf3d5ygdxc0000gn/T/tmpm3td1trx.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/v6/6q3jy9nd3pscgwcf3d5ygdxc0000gn/T/tmpm3td1trx.js
// include: /var/folders/v6/6q3jy9nd3pscgwcf3d5ygdxc0000gn/T/tmpbagmfof2.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/v6/6q3jy9nd3pscgwcf3d5ygdxc0000gn/T/tmpbagmfof2.js
...
// Begin JS library code
  ...
  function _MTLCreateSystemDefaultDevice(...args
  ) {
  abort('missing function: MTLCreateSystemDefaultDevice');
  }
  _MTLCreateSystemDefaultDevice.stub = true;
...
/** @type {function(string, boolean=, number=)} */
  ...
  function _class_addMethod(...args
  ) {
  abort('missing function: class_addMethod');
  }
  _class_addMethod.stub = true;

  function _clock_gettime_nsec_np(...args
  ) {
  abort('missing function: clock_gettime_nsec_np');
  }
  _clock_gettime_nsec_np.stub = true;
  ...
  function _objc_allocateClassPair(...args
  ) {
  abort('missing function: objc_allocateClassPair');
  }
  _objc_allocateClassPair.stub = true;

  function _objc_autoreleasePoolPop(...args
  ) {
  abort('missing function: objc_autoreleasePoolPop');
  }
  _objc_autoreleasePoolPop.stub = true;

  function _objc_autoreleasePoolPush(...args
  ) {
  abort('missing function: objc_autoreleasePoolPush');
  }
  _objc_autoreleasePoolPush.stub = true;

  function _objc_getAssociatedObject(...args
  ) {
  abort('missing function: objc_getAssociatedObject');
  }
  _objc_getAssociatedObject.stub = true;

  function _objc_getClass(...args
  ) {
  abort('missing function: objc_getClass');
  }
  _objc_getClass.stub = true;

  function _objc_msgSend(...args
  ) {
  abort('missing function: objc_msgSend');
  }
  _objc_msgSend.stub = true;

  function _objc_registerClassPair(...args
  ) {
  abort('missing function: objc_registerClassPair');
  }
  _objc_registerClassPair.stub = true;

  function _objc_setAssociatedObject(...args
  ) {
  abort('missing function: objc_setAssociatedObject');
  }
  _objc_setAssociatedObject.stub = true;

  function _sel_registerName(...args
  ) {
  abort('missing function: sel_registerName');
  }
  _sel_registerName.stub = true;
...
function assignWasmExports(wasmExports) {
  ...
  __sapp_emsc_onpaste = Module['__sapp_emsc_onpaste'] = createExportWrapper('_sapp_emsc_onpaste', wasmExports['_sapp_emsc_onpaste'], 1);
  __sapp_html5_get_ask_leave_site = Module['__sapp_html5_get_ask_leave_site'] = createExportWrapper('_sapp_html5_get_ask_leave_site', wasmExports['_sapp_html5_get_ask_leave_site'], 0);
  __sapp_emsc_begin_drop = Module['__sapp_emsc_begin_drop'] = createExportWrapper('_sapp_emsc_begin_drop', wasmExports['_sapp_emsc_begin_drop'], 1);
  __sapp_emsc_drop = Module['__sapp_emsc_drop'] = createExportWrapper('_sapp_emsc_drop', wasmExports['_sapp_emsc_drop'], 2);
  __sapp_emsc_end_drop = Module['__sapp_emsc_end_drop'] = createExportWrapper('_sapp_emsc_end_drop', wasmExports['_sapp_emsc_end_drop'], 3);
  __sapp_emsc_invoke_fetch_cb = Module['__sapp_emsc_invoke_fetch_cb'] = createExportWrapper('_sapp_emsc_invoke_fetch_cb', wasmExports['_sapp_emsc_invoke_fetch_cb'], 8);
  __sapp_emsc_set_fullscreen_flag = Module['__sapp_emsc_set_fullscreen_flag'] = createExportWrapper('_sapp_emsc_set_fullscreen_flag', wasmExports['_sapp_emsc_set_fullscreen_flag'], 1);
...
var wasmImports = {
  /** @export */
  MTLCreateSystemDefaultDevice: _MTLCreateSystemDefaultDevice,
  /** @export */
  ...
  /** @export */
  class_addMethod: _class_addMethod,
  /** @export */
  clock_gettime_nsec_np: _clock_gettime_nsec_np,
  /** @export */
  ...
  fd_write: _fd_write,
  /** @export */
  objc_allocateClassPair: _objc_allocateClassPair,
  /** @export */
  objc_autoreleasePoolPop: _objc_autoreleasePoolPop,
  /** @export */
  objc_autoreleasePoolPush: _objc_autoreleasePoolPush,
  /** @export */
  objc_getAssociatedObject: _objc_getAssociatedObject,
  /** @export */
  objc_getClass: _objc_getClass,
  /** @export */
  objc_msgSend: _objc_msgSend,
  /** @export */
  objc_registerClassPair: _objc_registerClassPair,
  /** @export */
  objc_setAssociatedObject: _objc_setAssociatedObject,
  /** @export */
  ...
  sapp_js_set_favicon,
  /** @export */
  sel_registerName: _sel_registerName,
  /** @export */
